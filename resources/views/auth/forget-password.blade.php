                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-4 p-sm-5">
                                    ...
                                    <p class="card-text mb-5">Masukkan email anda yang tergistrasi untuk mereset
                                        password!</p>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control form-control-lg radius-30"
                                                    id="inputEmailid" placeholder="Masukkan Email Anda">
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid gap-3">
                                                    <button type="submit"
                                                        class="btn btn-lg btn-primary radius-30">Kirim</button>
                                                    <a href="{{ route('showformlogin') }}"
                                                        class="btn btn-lg btn-danger radius-30">Kembali Ke Login</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
